...
var employee = empBuilder
    ...
    .SetUserName("nebi güler")
    .SetEmailAddress("nebi güler@gmail.com")
    .BuildEmployee();

// System.Console.WriteLine("M1 Employee FirstName: " + employee.FirstName);


var emp = GenerateEmployee("nebi güler", "nebigüler@gmail.com", 0);
System.Console.WriteLine("Email Address: " + emp.EmailAddress);
/*
IEmployeeBuilderM2 employeeBuilder = new InternalEmployeeBuilder();

employeeBuilder.SetEmailAddress("nebigüler@gmail.com");
employeeBuilder.SetFullName("nebi güler");
